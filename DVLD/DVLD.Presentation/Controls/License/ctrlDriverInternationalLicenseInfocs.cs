...
{
    public partial class ctrlDriverInternationalLicenseInfocs : UserControl
    {
        private int _InternationalLicenseID;
        private clsInternationalLicense _InternationalLicense;
        public ctrlDriverInternationalLicenseInfocs()
        {
            InitializeComponent();
        }
        private void _LoadPersonImage()
        {
            if (_InternationalLicense.DriverInfo.PersonInfo.GenderID == 1)
        ...
        public void LoadInfo(int InternationalLicenseID)
        {
            ...
            lblGendor.Text = _InternationalLicense.DriverInfo.PersonInfo.GenderID == 1 ? "Male" : "Female";
