...
namespace DVLD.Presentation.Controls.Test
{
    public partial class crlScheduleTest : UserControl
    {
                    ...
                    case clsTestType.enTestType.VisionTest:
                        {
                            ...
                            pbTestTypeImage.Image = Resources.Vision512;
                            break;
                        }
                    ...
                    case clsTestType.enTestType.WrittenTest:
                        {
                            ...
                            pbTestTypeImage.Image = Resources.WrittenTest512;
                            break;
                        }
                    case clsTestType.enTestType.StreetTest:
                        {
                            gbTestType.Text = "Street Test";
                            pbTestTypeImage.Image = Resources.driving_test512;
                            break;
        ...
        {
            if (_Mode == enMode.AddNew && clsLDLApp.IsThereAnActiveScheduledTest(_LocalDrivingLicenseApplicationID, _TestTypeID))
            {
