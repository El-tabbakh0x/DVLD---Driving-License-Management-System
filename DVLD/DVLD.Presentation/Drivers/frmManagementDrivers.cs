...
{
    public partial class frmManagementDrivers : Form
    {
        private DataTable _dtAllDrivers;
        public frmManagementDrivers()
        {
            InitializeComponent();
        }

        private void frmManagementDrivers_Load(object sender, EventArgs e)
        {
        ...
        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();
            frmManagementDrivers_Load(null, null);
        }
