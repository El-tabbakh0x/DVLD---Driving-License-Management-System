...
namespace DVLD.Presentation.Applications.Local_Driving_License
{
    public partial class frmAddUpdateLocalDrivingLicesnseApplication : Form
    {
        ...
        clsLDLApp _LocalDrivingLicenseApplication;
        ...
        private void _FillLicenseClassesInComoboBox()
        {
            ...
            {
                cbLicenseClass.Items.Add(row["LicenseClassName"]);
            }
        }
        private void _ResetDefualtValues()
        {
            ...
            if (_Mode == enMode.AddNew)
            {
                ...
                _LocalDrivingLicenseApplication = new clsLDLApp();
        ...
        private void _LoadData()
        {
            ...
            ctrlPersonInfoWithFilter1.LoadData(_LocalDrivingLicenseApplication.ApplicantPersonID);
            ...
            lblCreatedByUser.Text = clsUser.FindUserInfoByUserID(_LocalDrivingLicenseApplication.CreatedByUserID).UserName;
        }
        private void DataBackEvent(object sender, int PersonID)
        {
            _SelectedPersonID = PersonID;
            ctrlPersonInfoWithFilter1.LoadData(PersonID);
        }
        //=================================
        // Form Events
        //=================================
