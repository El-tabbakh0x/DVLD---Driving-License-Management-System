...
{
    public partial class frmManagementLocalDrivingLicesnseApplications : Form
    {
        private DataTable _dtAllLocalDrivingLicenseApplications;
        public frmManagementLocalDrivingLicesnseApplications()
        {
            InitializeComponent();
        }
        ...
        private void frmManagementLocalDrivingLicesnseApplications_Load(object sender, EventArgs e)
        {
            _dtAllLocalDrivingLicenseApplications = clsLDLApp.GetAllLocalDrivingLicenseApplications();
        ...
        {
            int LocalDrivingLicenseApplicationID = (int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value;
            int LicenseID = clsLDLApp.FindByLocalDrivingAppLicenseID(LocalDrivingLicenseApplicationID).GetActiveLicenseID();
            if (LicenseID != -1)
            {
        ...
        private void CancelApplicaitonToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            clsLDLApp LocalDrivingLicenseApplication =
                clsLDLApp.FindByLocalDrivingAppLicenseID(LocalDrivingLicenseApplicationID);
        ...
        {
            int LocalDrivingLicenseApplicationID = (int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value;
            clsLDLApp localDrivingLicenseApplication = clsLDLApp.FindByLocalDrivingAppLicenseID(LocalDrivingLicenseApplicationID);
