...
namespace DVLD.Business
{
    public class clsLDLApp : clsApplication
    {
        ...
        private clsLDLApp(int LocalDrivingLicenseApplicationId, int ApplicationId, int ApplicantPersonId,
        ...
        public static clsLDLApp FindByLocalDrivingAppLicenseID(int LocalDrivingLicenseApplicationID)
        {
        ...
        public static clsLDLApp FindByApplicationID(int ApplicationID)
        {
